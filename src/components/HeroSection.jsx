      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            אלפי חשבונות שוחזרו בהצלחה, גם כשמטא אמרו שאין סיכוי. תשלום רק אחרי הצלחה מוכחת.
            <br />
            <strong style={{ color: '#3B82F6' }}>וגם פתרונות לעסקים: ביזנס מנג׳ר, דפים עסקיים וחשבונות מודעות</strong>
          </p>

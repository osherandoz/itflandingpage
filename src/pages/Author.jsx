...
const STR = {
  ...
  en: {
    ...
    steps: [
      ...
      { title: 'We get to work', text: `Once we're set, we get to work. How long it takes ${FACTS.typicalTurnaround.en.toLowerCase()} — simple cases are quick, complex ones take longer.` },
    ],

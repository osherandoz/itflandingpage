...
const pageData = SERVICE_PAGES_EN.find(p => p.slug === 'whatsapp-recovery');
...
export const meta = () => [
  ...
  { property: 'og:url', content: 'https://www.israeltechforce.com/en/whatsapp-account-recovery' },
  { property: 'og:locale', content: 'en_US' },
  { property: 'og:image', content: 'https://www.israeltechforce.com/images/og-card.png' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { tagName: 'link', rel: 'canonical', href: 'https://www.israeltechforce.com/en/whatsapp-account-recovery' },
  ...hreflangLinks('/שחזור-חשבון-וואטסאפ', '/en/whatsapp-account-recovery'),
];
...
const SERVICE_SCHEMA = {
  ...
  url: 'https://www.israeltechforce.com/en/whatsapp-account-recovery',
};
...
export default function EnWhatsAppRecoveryRoute() {
  return (
    <>
      <script

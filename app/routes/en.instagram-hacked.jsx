...
const pageData = SERVICE_PAGES_EN.find(p => p.slug === 'instagram-hacked');
...
export const meta = () => [
  ...
  { property: 'og:url', content: 'https://www.israeltechforce.com/en/instagram-account-hacked' },
  { property: 'og:locale', content: 'en_US' },
  { property: 'og:image', content: 'https://www.israeltechforce.com/images/og-card.png' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { tagName: 'link', rel: 'canonical', href: 'https://www.israeltechforce.com/en/instagram-account-hacked' },
  ...hreflangLinks('/חשבון-אינסטגרם-נפרץ', '/en/instagram-account-hacked'),
];
...
const SERVICE_SCHEMA = {
  ...
  url: 'https://www.israeltechforce.com/en/instagram-account-hacked',
};
...
export default function EnInstagramHackedRoute() {
  return (
    <>
      <script

...
const pageData = SERVICE_PAGES.find(p => p.slug === 'facebook-disabled');
...
export const meta = () => [
  ...
  { property: 'og:url', content: 'https://www.israeltechforce.com/חשבון-פייסבוק-מושבת' },
  { property: 'og:locale', content: 'he_IL' },
  { property: 'og:image', content: 'https://www.israeltechforce.com/images/og-card.png' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { tagName: 'link', rel: 'canonical', href: 'https://www.israeltechforce.com/חשבון-פייסבוק-מושבת' },
...
const SERVICE_SCHEMA = {
  ...
  url: 'https://www.israeltechforce.com/חשבון-פייסבוק-מושבת',
};
...
export default function FacebookDisabledRoute() {
  return (
    <>
      <script

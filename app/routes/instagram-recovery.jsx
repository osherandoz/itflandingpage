...
const pageData = SERVICE_PAGES.find(p => p.slug === 'instagram-recovery');
...
const SERVICE_SCHEMA = {
  ...
  url: 'https://www.israeltechforce.com/שחזור-חשבון-אינסטגרם',
};
...
export default function InstagramRecoveryRoute() {
  return (
    <>
      <script

...
const pageData = SERVICE_PAGES_EN.find(p => p.slug === 'instagram-recovery');
...
export const meta = () => [
  ...
  { property: 'og:url', content: 'https://www.israeltechforce.com/en/instagram-account-recovery' },
  { property: 'og:locale', content: 'en_US' },
  { property: 'og:image', content: 'https://www.israeltechforce.com/images/og-card.png' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { tagName: 'link', rel: 'canonical', href: 'https://www.israeltechforce.com/en/instagram-account-recovery' },
  ...hreflangLinks('/שחזור-חשבון-אינסטגרם', '/en/instagram-account-recovery'),
];
...
const SERVICE_SCHEMA = {
  ...
  url: 'https://www.israeltechforce.com/en/instagram-account-recovery',
};
...
export default function EnInstagramRecoveryRoute() {
  return (
    <>
      <script

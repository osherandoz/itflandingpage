...
export const meta = () => [
  ...
  { property: 'og:url', content: 'https://www.israeltechforce.com/שחזור-חשבון-וואטסאפ' },
  { property: 'og:locale', content: 'he_IL' },
  { property: 'og:image', content: 'https://www.israeltechforce.com/images/og-card.png' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { tagName: 'link', rel: 'canonical', href: 'https://www.israeltechforce.com/שחזור-חשבון-וואטסאפ' },
...
const SERVICE_SCHEMA = {
  ...
  url: 'https://www.israeltechforce.com/שחזור-חשבון-וואטסאפ',
};

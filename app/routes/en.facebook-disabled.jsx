...
const pageData = SERVICE_PAGES_EN.find(p => p.slug === 'facebook-disabled');
...
export const meta = () => [
  ...
  { property: 'og:url', content: 'https://www.israeltechforce.com/en/facebook-account-disabled' },
  { property: 'og:locale', content: 'en_US' },
  { property: 'og:image', content: 'https://www.israeltechforce.com/images/og-card.png' },
  { name: 'twitter:card', content: 'summary_large_image' },
  { tagName: 'link', rel: 'canonical', href: 'https://www.israeltechforce.com/en/facebook-account-disabled' },
  ...hreflangLinks('/חשבון-פייסבוק-מושבת', '/en/facebook-account-disabled'),
];
...
const SERVICE_SCHEMA = {
  ...
  url: 'https://www.israeltechforce.com/en/facebook-account-disabled',
};
...
export default function EnFacebookDisabledRoute() {
  return (
    <>
      <script
